...
import TirzepatideTreatmentAssistant from "@/components/calculators/tirzepatide-treatment-assistant"
...
export default function TirzepatideDoseCalculatorPage() {
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <CalculatorSchema name="Tirzepatide Dose Calculator" description={DESCRIPTION} url={URL} />
      <FAQSchema faqs={faq} />
      ...
      <main id="main" className="flex-1">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            ...
            <CatalogRelatedCalculators slug="tirzepatide-dose-calculator" />
