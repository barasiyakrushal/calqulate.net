          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none mt-16 space-y-16">
              ...
              <ServiceCTA
                ...
                body="This snapshot is one moment in your treatment. Calqulate Vitals logs every injection, charts your medication levels between doses, and checks you against the clinical trials, all free. Premium tracks fat vs. muscle as you lose and predicts the week your progress is likely to plateau, before it happens."
                bullets={[
